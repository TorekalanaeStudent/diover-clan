...
public class OrderServiceImplimentation implements OrderService {
    ...
    // GRASP: Low Coupling — depends on the interface, not the concrete class
    // GRASP: Indirection — goes through repository, never touches DB directly
    private final OrderRepository orderRepository;

    // GRASP: Pure Fabrication — validator is injected, not created here
