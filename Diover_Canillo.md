...
|------------|------------------|----------------------------------------------------------------------|-------|--------------|
| 2026-04-21 | PR Review        | Nono (Approved, Commented: Score Update) - #878                      | 2     | 405          |
...
commented and approved nono's (changelog) pr: 2 points - #804 \
commented and approved ablis (peer_feedback) pr: 2 points - #805 \
commented and approved nono (peer_feedback) pr: 2 points - #806 \
commented and approved ablis (peer_feedback) pr: 2 points - #807 \
commented and approved cardeno's (demo_abstract) pr: 2 points - #808 \
commented and approved cardeno's (journal) pr: 2 points - #812 \
commented and approved cardeno's (peer_feedback) pr: 2 points - #813 \
commented and approved onte's (journal) pr: 2 points - #815 \
commented and approved go's (journal) pr: 2 points - #817 \
commented and approved caneda's (analysis_demo) pr: 2 points - #818 \
commented and approved trespeces (demo_exception) pr: 2 points - #819 \
commented and approved go's (peer_interview) pr: 2 points - #820 \
commented and approved jagunap's (folder_add) pr: 2 points - #821 \
commented and approved arban's (exception_everything) pr: 2 points - #822 \
commented and approved arban's (implementation_abstraction) pr: 2 points - #823 \
commented and approved jagunap's (calculator_exception) pr: 2 points - #825 \
commented and approved jagunap's (changelog_abstraction) pr: 2 points - #826 \
commented and approved jagunap's (changelog_exceptions) pr: 2 points - #828 \
commented and approved onte's (calculator_exception) pr: 2 points - #830 \
commented and approved rajan's (calculator_exception) pr: 2 points - #832 \
commented and approved jagunap's (journal) pr: 2 points - #832 \
...
### did 04/18/2026
commented and approved ovejera's (demo_abstraction) pr: 2 points - #745 \
commented and approved obedoza's (demo_abstraction) pr: 2 points - #746 \
commented and approved trespeces (implementation) pr: 2 points - #747 \
commented and approved de juras' (implementations) pr: 2 points - #748 \
commented and approved onte (implementation) pr: 2 points - #749 \
commented and approved ablis (implementation) pr: 2 points - #750 \
commented and approved gedoria's (implementation_and_demo) pr: 2 points - #753 \
commented and approved obedoza's (journal_update) pr: 2 points - #754 \
commented and approved Go's (interface_and_abstract) pr: 2 points - #755 \
commented and approved Janelle's (composition_composed_class) pr: 2 points - #757 \
commented and approved Caneda's (demo_folder_for_exception) pr: 2 points - #758 \
commented and approved Caneda's (abstraction_everything) pr: 2 points - #759 \
commented and approved Janelle's (changelog_update) pr: 2 points - #761 \
commented and approved Janelle's (journal) pr: 2 points - #762 \
commented and approved Janelle's (peer_feedback) pr: 2 points - #763 \
commented and approved Janelle's (peer_feedback) pr: 2 points - #764 \
commented and approved trespeces (demo_class_abstraction) pr: 2 points - #767 \
commented and approved Janelle's (demo_class_abstraction) pr: 2 points - #769 \
commented and approved Navarro's (fixes) pr: 2 points - #770 \
commented and approved Navarro's (peer_review) pr: 2 points - #771 \
commented and approved Exodia's (exception) pr: 2 points - #774 \
change requested, commented and finally approved Caneda's (exception_demo) pr: 4 points - #777 \
commented and approved Go's (abstract_everything) pr: 2 points - #778 \
commented and approved Cardeno (implementations) pr: 2 points - #780 \
commented and approved Caneda's (changelog) pr: 2 points - #781 \
commented and approved Navarro's (journal_update) pr: 2 points - #783 \
commented and approved Onte's (calculator_class) pr: 2 points - #785 \
commented and approved gedoria's (changelog) pr: 2 points - #786 \
commented and approved arban (first_implementation) pr: 2 points - #787 \
change requested, commented and finally approved obedoza's (exception_calculator) pr: 4 points - #788 \
commented and approved TeamJina's (calculator) pr: 2 points - #791 \
commented and approved ablis (changelog) pr: 2 points - #793 \
commented and approved de juras (demo_class_abstraction) pr: 2 points - #799 \
commented and approved nono's (demo_class_abstraction) pr: 2 points - #801

---

### did 04/16/2026
commented and approved on onte (interface_and_abstract) pr: 2 points - #731 \
commented and approved on ovejera's (interface_and_abstract) pr: 2 points - #732 \
commented and approved on ablis' (interface_and_abstract) pr: 2 points - #733 \
commented and approved on rajan's (interface_and_abstract) pr: 2 points - #734

---

### did 04/15/2026
commented and approved on navarro's (demo_class) pr: 2 points - #719 \
commented and approved on trespeces (journal) pr: 2 points - #721 \
commented and approved on malig's (sub_class) pr: 2 points - #723 \
commented and approved on arban's (interface_and_abstract) pr: 2 points - #726 \
commented and approved on de-juras (interface_and_abstract) pr: 2 points - #727 \
commented and approved on onte (demo_class_comp) pr: 2 points - #728 \
commented and approved on trespeces (interface_and_abstract) pr: 2 points - #729 \
commented and approved on obedoza (abstract) pr: 2 points - #730

---

### did 04/02/2026
commented and approved on nono's (journal-fix) pr: 2 points - #692 \
commented and approved on cardeno's (demo_class) pr: 2 points - #693

---

### did 03/31/2026
commented and approved on navarro's (abstract and interface) pr: 2 points - #664 \
commented and approved on ramil's (peer_feedback) pr: 2 points - #666 \
commented and approved on nono's (team_changelog) pr: 2 points - #684 \
commented and approved on nono's (journal) pr: 2 points - #685

---

### did 03/30/2026
commented and approved on De juras' (team-changelog) pr: 2 points - #627 \
commented and approved on ablis' (peer_feedback) pr: 2 points - #650 \
commented and approved on ablis' (peer_feedback) pr: 2 points - #651 \
commented and approved on ablis' (peer_feedback) pr: 2 points - #652 \
commented and approved on caneda's (sub_class) pr: 2 points - #653 \
commented and approved on caneda's (composed_class) pr: 2 points - #654 \
commented and approved on caneda's (comp_demo) pr: 2 points - #655 \
commented and approved on ablis' (journal) pr: 2 points - #656 \
commented and approved on ablis' (team_changelog) pr: 2 points - #657 \
commented and approved on nono's (sub_class) pr: 2 points - #658 \

---

### did 03/29/2026
commented and approved on De juras' (peer_feedback) pr: 2 points - #628 \
commented and approved on overjera's (component_class) pr: 2 points - #632 \
commented and approved on ovejera's (team_changelog) pr: 2 points - #634 \
commented and approved on overjera's (peer_feedback) pr: 2 points - #635 \
commented and approved on malig's (composed_class) pr: 2 points - #637 \
commented and approved on ablis' (everything) pr: 2 points - #638 \
commented and approved on jagunap's (component_class) pr: 2 points - #640 \
commented and approved on jagunap's (inheritance_logs) pr: 2 points - #641 \
commented and approved on jagunap's (journal_inheritance) pr: 2 points - #642 \
commented and approved on jagunap's (peer_feedback) pr: 2 points - #643 \
commented and approved on rajan's (composed_class) pr: 2 points - #644 \
commented and approved on onte's (composed_class) pr: 2 points - #647 \
commented and approved on Go's (everything_composition) pr: 2 points - #648 \
commented and approved on De juras' (peer_feedback) pr: 2 points - #649

---

### did 03/24/2026
commented and approved on onte's (team_changelog) pr: 2 points - #572 \
commented and approved on ablis' (team_changelog) pr: 2 points - #575 \
commented and approved on ziggy's (journal) pr: 2 points - #582 \
commented and approved on trespeces' (team_changelog) pr: 2 points - #583 \
commented and approved on ziggy's (main_inheritance-class) pr: 2 points - #604 \
commented and approved on caneda's (team_changelog) pr: 2 points - #607 \
commented and approved on caneda's (journal) pr: 2 points - #608 \
commented and approved on caneda's (peer_feedback) pr: 2 points - #610


### did 03/22/2026
commented, approved, and requested change on de juras' (main_class) pr: 4 points - #567 \
commented and approved on trespeces' (main_class) pr: 2 points - #568 \
commented, approved, and requested change on matilda's (main_class) pr: 4 points - #570

---

### did 03/21/2026
commented and approved on rajan's (main_class) pr: 2 points - #553   \
commented and approved on rajan's (team_changelog) pr: 2 points - #554   \
commented and approved on ablis' (sub_class) pr: 2 points - #562   \
commented and approved on seth go's (team_changelog) pr: 2 points - #563   \
commented and approved on malig's (main and sub class) pr: 2 points - #565   \
commented and approved on ablis' (sub_class) pr: 2 points - #566  
...
commented, approved, and requested change on ziggy's (sub and parent class) pr: 4 points - #551   \
commented and approved on caneda's (main and sub class) pr: 2 points - #552   \
commented and approved on rajan's (team-changelog) pr: 2 points - #554   \
commented and approved on onte's (main and sub class) pr: 2 points - #556   \
commented and approved on onte's (journal) pr: 2 points - #557   \
commented and approved on onte's (late-peer_feedback) pr: 2 points - #558   \
commented and approved on onte's (late-peer_feedback) pr: 2 points - #559   \
commented and approved on onte's (peer_feedback) pr: 2 points - #561  
