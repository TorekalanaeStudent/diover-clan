...
public class PC {
    ...
    public PC(String caseColor){
       this();
       this.caseColor = caseColor;
    }

    // overloading constructor (2)
    public PC(String GPUManufacturer, int GPUModel){
       this();
    ...
    public PC(String GPUManufacturer, int GPUModel, String MOBO, String CPU, int RSpeed, int RSize){
       this.GPUManufacturer = GPUManufacturer;
       this.GPUModel = GPUModel;
       this.MOBO = MOBO;
       this.CPU = CPU; 
