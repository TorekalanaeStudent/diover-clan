...
public class Samsung_Trespeces extends Gadget_Ovejera implements SmartphoneSystem_Ovejera {

    // constructor
    public Samsung_Trespeces(String name, String brand, int batteryLevel, int price) {
    ...
    public void sendMessage(String message) {
        System.out.println(getName() + " sent via Samsung Messages: \"" + message + "\"");
    }
